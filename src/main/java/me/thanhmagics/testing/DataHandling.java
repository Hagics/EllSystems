...
public class DataHandling {
    ...
    public static LinkedList<String> getData(String path) {
        return getData(path, new StringHandler() {
            @Override
    ...
    public static LinkedList<String> getData(String path, StringHandler handler) {
    ...
    public abstract static class StringHandler {
